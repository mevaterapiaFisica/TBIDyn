...
namespace TBIDyn
{
    public class Minado
    {
        ...
        { 
            return Vol_body==0 || Vol_lungs==0 || Diam_origen ==double.NaN || z_rodilla ==double.NaN || arcos.Any(a=>a==null) || regiones.Any(r=>r.media==0 ||r.media==double.NaN);
        }
        ...
        {
            return "ID,Vol_body,Vol_lungs,Diam_origen,med_4,sd_4,perc80_4,perc20_4,med_3,sd_3,perc80_3,perc20_3,weight_por_norm_3,long_arco_4,weight_por_norm_4";
        }
        public static string EtiquetasWeightArco1()
        {
            return "ID,Vol_body,Vol_lungs,Diam_origen,med_1,sd_1,perc80_1,perc20_1,med_2,sd_2,perc80_2,perc20_2,weight_por_norm_2,long_arco_1,weight_por_norm_1";
        }

        public string ToStringUMArco3()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString()+ "," + Diam_origen.ToString() + "," + regiones[2].ToString() + "," + arcos[2].long_arco.ToString() + "," + arcos[2].um_por_gray.ToString() + "," + arcos[2].ums_por_gray_grado.ToString();
        }
        public string ToStringUMArco2()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString() + "," + Diam_origen.ToString() + "," + regiones[1].ToString() + "," + regiones[2].ToString() + "," + arcos[2].um_por_gray.ToString() + "," + arcos[1].long_arco.ToString() + "," + arcos[1].um_por_gray.ToString() + "," + arcos[1].ums_por_gray_grado.ToString();
        }
        public string ToStringUMArco4()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString() + "," + Diam_origen.ToString() + "," + regiones[3].ToString() + "," + regiones[2].ToString() + "," + arcos[2].um_por_gray.ToString() + "," + arcos[3].long_arco.ToString() + "," + arcos[3].um_por_gray.ToString() + "," + arcos[3].ums_por_gray_grado.ToString();
        }
        public string ToStringUMArco1()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString() + "," + Diam_origen.ToString() + "," + regiones[0].ToString() + "," + regiones[1].ToString() + "," + arcos[1].um_por_gray.ToString() + "," + arcos[0].long_arco.ToString() + "," + arcos[0].um_por_gray.ToString() + "," + arcos[0].ums_por_gray_grado.ToString();
        }

        public string ToStringWeightArco3()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString() + "," + Diam_origen.ToString() + "," + regiones[2].ToString() + "," + arcos[2].long_arco.ToString() + "," + arcos[2].weight_por_norm.ToString();
        }
        public string ToStringWeightArco2()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString() + "," + Diam_origen.ToString() + "," + regiones[1].ToString() + "," + regiones[2].ToString() + "," + arcos[2].weight_por_norm.ToString() + "," + arcos[1].long_arco.ToString() + "," + arcos[1].weight_por_norm.ToString();
        }
        public string ToStringWeightArco4()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString() + "," + Diam_origen.ToString() + "," + regiones[3].ToString() + "," + regiones[2].ToString() + "," + arcos[2].weight_por_norm.ToString() + "," + arcos[3].long_arco.ToString() + "," + arcos[3].weight_por_norm.ToString();
        }
        public string ToStringWeightArco1()
        {
            return ID + "," + Vol_body.ToString() + "," + Vol_lungs.ToString() + "," + Diam_origen.ToString() + "," + regiones[0].ToString() + "," + regiones[1].ToString() + "," + arcos[1].weight_por_norm.ToString() + "," + arcos[0].long_arco.ToString() + "," + arcos[0].weight_por_norm.ToString();
        }
        public string ToStringGantryArco1()
        {
            return ID + "," + Diam_origen.ToString() + "," + z_pies.ToString() + "," + z_rodilla.ToString() + "," + arcos[0].gantry_inicio.ToString() + "," + arcos[0].gantry_fin.ToString();
        }

        public string ToStringGantryArco2()
        {
            return ID + "," + Diam_origen.ToString() + "," + z_rodilla.ToString() + "," + z_lung_inf.ToString() + "," + arcos[1].gantry_inicio.ToString() + "," + arcos[1].gantry_fin.ToString();
        }

        public string ToStringGantryArco3()
        {
            return ID + "," + Diam_origen.ToString() + "," + z_lung_inf.ToString() + "," + z_lung_sup.ToString() + "," + arcos[2].gantry_inicio.ToString() + "," + arcos[2].gantry_fin.ToString();
        }

        public string ToStringGantryArco4()
        {
            return ID + "," + Diam_origen.ToString() + "," + z_lung_sup.ToString() + "," + z_cabeza.ToString() + "," + arcos[3].gantry_inicio.ToString() + "," + arcos[3].gantry_fin.ToString();
        }
